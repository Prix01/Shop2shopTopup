...
use PrixAPILib\Controllers\APIController;
use PrixAPILib\Utils\CompatibilityConverter;
use Unirest\Configuration;
use Unirest\HttpClient;

class PrixAPIClient implements ConfigurationInterface
{
    private $client2;
    ...
    /**
     * @see PrixAPIClientBuilder::init()
     * @see PrixAPIClientBuilder::build()
     *
     * @param array $config
     */
     ...
     *
     * @return PrixAPIClientBuilder PrixAPIClientBuilder instance
     */
    public function toBuilder(): PrixAPIClientBuilder
    {
        return PrixAPIClientBuilder::init()
     ...
     *
     * @see PrixAPIClientBuilder::getConfiguration()
     */
